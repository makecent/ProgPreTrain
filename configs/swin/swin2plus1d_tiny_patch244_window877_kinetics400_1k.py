...
model=dict(backbone=dict(type='SwinTransformer2plus1D', patch_size=(2,4,4), drop_path_rate=0.1), test_cfg=dict(max_testing_views=4))
...
# optimizer
optimizer = dict(type='AdamW', lr=5e-4, betas=(0.9, 0.999), weight_decay=0.02,
