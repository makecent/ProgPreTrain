...
# model = build_backbone(Config.fromfile(
#     "configs/timesformer/in_proj/timesformer_decST_8x4_1_15e_sthv2_rgb.py").model.backbone)
model = build_backbone(Config.fromfile(
    "configs/timesformer/in_proj/timesformer_decST_no_inproj_equalflop_8x4_1_15e_sthv2_rgb.py").model.backbone)
