...
model = build_backbone(Config.fromfile(
    "configs/timesformer/timesformer06_divST_INpre_8x32x1_15e_k200_rgb.py").model.backbone)
...
inputs = torch.randn(1, 3, 8, 224, 224)
model = build_backbone(Config.fromfile(
    "configs/timesformer/timesformer06_convT_INpre_8x32x1_15e_k200_rgb.py").model.backbone)
